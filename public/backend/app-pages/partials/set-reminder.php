<?php
    require ABSOLUTE_PUBLIC_PATH .DS. 'backend' .DS. 'app-pages' .DS. 'scripts' .DS. 'set-reminder-js.php';
?>
<div id="hidden-reminder-item-holder" style="display: none;">
    ...
    <div class="row reminder-item m-t-10 m-b-20">
        ...
        <div id="actualtext" class="col p-l-0">
            Remind 
            <span class="reminder-customer-names" style="font-weight: bold"></span>
            <span class="frequency-pronoun"></span>
            <span class="reminder-due-date" style="font-weight: bold"></span>
            <span class="repeatunits"></span>
...
<div class="section-body" id="">
    ...
    <!-- Add Reminder Panel-->
    <div id="add-reminder-panel" class="panel panel-transparent no-shadow p-0 p-t-10">
        <div class="row">
        ...
        <div id="reminder-onetime" class="schedule-panel active">
            <input type="hidden" name="onetime-value" value="" />
            <div class="row">
                <div class="col">
                    <div class="row">
    ...
    <div id="reminder-repeat" class="schedule-panel">
        ...
        <div class="row">
            <div class="col p-r-0">
                <button id="close-reminder-panel" type="button" class="btn btn-light btn-rounded pull-left">
                    <i class="fa fa-close"></i>
                    Cancel
                </button>
            </div>
            <div class="col p-l-0">
                <button id="save-reminder" type="button" class="btn btn-success btn-rounded disabled pull-right">
