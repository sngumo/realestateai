<?php
namespace Jenga\App\Request\Facade;
...
class Sanitize
{
	...
	public static function is_valid(array $data, array $validators){
            ...
            $sanitize->validation_rules($validators);

            if($sanitize->run($data) === false) {
                return $sanitize->get_readable_errors(false);
            } else {
                return true;
            }
	}
        ...
        public static function isJson($string){
            $response = static::json_validate($string);
        ...
        /**
         * Checks full validation for JSON string
         * 
         * @param type $string
         * @return boolean
         */
	...
	public static function filter_input(array $data, array $filters)
	{
		...
		return $sanitize->filter($data, $filters);
	}
	...
	public function sanitize(array $input, $fields = NULL, $utf8_encode = true)
	{
        ...
        public static function shorten($entext,$charno,$addDots='yes'){
        ...
        /**
         * Replaces all special characters and spaces with underscores
         * 
         * @param type $string
         * @return type formatted string
         */
        public static function clean($string, $replacetxt = '_') {
            
           $string = str_replace(' ', $replacetxt, $string); // Replaces all spaces with hyphens.
           $string = preg_replace('/[^A-Za-z0-9\_]/', $replacetxt, $string); // Removes special chars.
